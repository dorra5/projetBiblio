...
<?php
 ...
 if(isset($_POST['save_admin'])){ 
     ...
     if($username&&$password&&$firstname&&$lastname&&$birthday ){
        $insert= $db->prepare(" INSERT INTO admin VALUES ('','$username','$password','$firstname','$lastname','$birthday')");
        $insert->execute();
         echo " <script> alert('admin ajouter avec succee'); </script>";
     }else {
...
<body>
    ...
    <div class="main">
        ...
        <form method ="POST" action ="" enctype = "multipart/form-data" id="admin_form">
            ...
            <div class = "form-group">
                <button type="submit"  name ="save_admin"><span class = "glyphicon glyphicon-save"></span> Submit</button>
            </div>
        </form>		
    </div>
