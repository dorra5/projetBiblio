...
?>
      <?php
          ...
          if(isset($_POST['edit_admin'])){
            ...
            $updateadmin = $db->prepare(" UPDATE admin SET username='$username',password='$password',firstname='$firstname',lastname='$lastname',birthday='$birthday' WHERE id=$id");
            $updateadmin->execute();
...
<div id="opacity">
    ...
    <div class="main">
        ...
        <div>
            <a href="accounts_admin.php"> <button class="back" ><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i>&nbsp;Back</button> </a>
        <!--     
        ...
        <?php
            $id=$_GET['id'];
            $select = $db->prepare(" SELECT * FROM admin WHERE id=$id");
            $select->execute();
          ...
          <form method ="POST" action ="" enctype = "multipart/form-data" id="admin_form" >
            ...
            <div class = "form-group">
                <button type="submit"  name ="edit_admin"><span class = "glyphicon glyphicon-save"></span> Save changes</button>
            </div>
        </form>	
