...
<body>
    ...
    <div class="main">
        ...
        <div>
            <a href="add_admin.php"> <button class="addNew" ><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Add New</button></a>
            <button id="show_admin" type="submit" name="show_admin" class="back" style = "display:none;"><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i>&nbsp;Back  </button>
        <!--     
        ...
        <div id="admin_show_part" >
            ...
            <table id="myTable">
               ...
               <?php
                   ...
                   $selectAdmin->execute();
                   while ($s=$selectAdmin->fetch()){
               ?>	
                <tr>
                    <td><?php echo $s['username']?></td>
                    <td><?php echo md5($s['password'])?></td>
                    <td><?php echo $s['firstname']?></td>
                    <td><?php echo $s['lastname']?></td>
                    <td><?php echo $s['birthday']?></td>
                    <td>
                        <a href="?action=deleteAdmin&amp;id=<?php echo $s['id']; ?>"> <button class="delete" ><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;Delete</button> </a>
                        <a href="edit_admin.php?id=<?php echo $s['id']; ?>"> <button class="edit" ><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;Edit</button> </a>
                    </td>
                </tr>
              <?php
                   }
