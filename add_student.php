...
<?php
 ...
 if(isset($_POST['save_student'])){ 
     ...
     if($username&&$password&&$firstname&&$lastname&&$birthday&&$cour&&$secteur ){
        $insert= $db->prepare(" INSERT INTO student VALUES ('','$username','$password','$firstname','$lastname','$birthday','$cour','$secteur')");
        $insert->execute();
         echo " <script> alert('student ajouter avec succee'); </script>";
     }else {
    ...
    <div class="main">
        ...
        <form method ="POST" action ="" enctype = "multipart/form-data" id="admin_form">
            ...
            <div class = "form-group">	
                ...
                <input type ="text" name ="birthday" required = "required" class = "form-control" />
            </div>
            <div class = "form-group">	
                <label>Cour:</label>
                <input type = "text" required = "required" name = "lastname" class = "form-control" />
            ...
            <div class = "form-group">
                <button type="submit"  name ="save_student"><span class = "glyphicon glyphicon-save"></span> Submit</button>
            </div>
        </form>		
    </div>
