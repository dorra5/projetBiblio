...
<?php
 ...
 if(isset($_POST['save_book'])){ 
     ...
     if($title&&$description&&$category&&$author&&$datepublish&&$qty&&$photo ){
        $insert= $db->prepare(" INSERT INTO book VALUES ('','$title','$description','$category','$author','$datepublish','$qty','$photo')");
        $insert->execute();
         echo " <script> alert('book ajouter avec succee'); </script>";
     }else {
    ...
    <div class="main">
        ...
        <form method ="POST" action ="" enctype = "multipart/form-data" id="admin_form">
            ...
            <div class = "form-group">	
                ...
                <input type ="text" name ="datepublish" required = "required" class = "form-control" />
            </div>
            <div class = "form-group">	
                <label>Qty:&nbsp;&nbsp;</label>
            ...
            <div class = "form-group">	
                <label>Photo:&nbsp;&nbsp;</label>
                <input type ="text" name ="photo" required = "required" class = "form-control" />
            </div>
            <div class = "form-group">
                <button type="submit"  name ="save_book"><span class = "glyphicon glyphicon-save"></span> Submit</button>
            </div>
        </form>		
    </div>
