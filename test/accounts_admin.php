...
<body>
    ...
    <div class="sidenav">
        <div id="opacity">
            ...
            <i class="fa fa-caret-down"></i>
                ...
                <a href="#"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Admins</a>
                <a href="#"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Students</a>

                </div>
            <a href="#clients"><i class="fa fa-book" aria-hidden="true"></i> &nbsp;Managing Books</a>
    ...
    <div class="main">
        ...
        <form method ="POST" action ="" enctype = "multipart/form-data" id="admin_form" style = "display:none;">
            ...
            <div class = "form-group">	
                <button type="button"  name = "save_admin"><span class = "glyphicon glyphicon-save"></span> Submit</button>
            </div>
        </form>		
    </div>
...
<script>
    ...
    $(document).ready(function(){
			$('#add_admin').click(function(){
				$(this).hide();
				$('#show_admin').show();
				$('#admin_show_part').slideUp();
				$('#admin_form').slideDown();
				$('#show_admin').click(function(){
					$(this).hide();
					$('#add_admin').show();
					$('#admin_show_part').slideDown();
					$('#admin_form').slideUp();
				});
			});
		});
