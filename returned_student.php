...
if(isset($_GET['action'])){
     if($_GET['action']=='return')  { 
       ...
       $update->execute();
       header('Location:returned_student.php');
     }
}
...
<head>
    ...
    <style>
       ...
       /* Fixed sidenav, full height */
        ...
        #student1{margin:40px 80px 0px 163px;}
        #student{margin:40px 80px 10px 163px;}
        #msgEtat p{
            font-size: 18px;
            vertical-align: middle;
        }
        ...
        <div id="admin_show_part" >
            ...
            <table id="myTable">
               ...
               <?php
                ...
                $select->execute();  
                $d=$select->fetch() ;
                $selectBook=$db->prepare("SELECT * FROM borrowing where student_id = '$d[id]' ");
                $selectBook->execute();
