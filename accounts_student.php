...
if(isset($_GET['action'])){
         ...
         $id=$_GET['id'];
         $deleteadmin = $db->prepare(" DELETE FROM student WHERE id=$id");
         $deleteadmin->execute();
...
<body>
    ...
    <div class="main">
        ...
        <div>
            <a href="add_student.php"> <button class="addNew" ><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Add New</button></a>
        <!--     
        ...
        <div id="admin_show_part" >
            ...
            <table id="myTable">
               ...
               <?php
                   $selectStudent=$db->prepare("SELECT * FROM student");
                   $selectStudent->execute();
                   while ($s=$selectStudent->fetch()){
               ?>	
                <tr>
                    ...
                    <td><?php echo $s['secteur']?></td>
                    <td>
                        <a href="?action=deleteStudent&amp;id=<?php echo $s['id']; ?>"> <button class="delete" ><i class="fa fa-trash-o" aria-hidden="true"></i>&nbsp;&nbsp;Delete</button> </a>
                        <a href="edit_student.php?id=<?php echo $s['id']; ?>"> <button class="edit" ><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;&nbsp;Edit</button> </a>
                    </td>
                </tr>
              <?php
                   }
