...
?>
      <?php
          ...
          if(isset($_POST['edit_book'])){
            ...
            $updatebook = $db->prepare(" UPDATE book SET title='$title',description='$description',category='$category',author='$author',datepublish='$datepublish',qty='$qty',photo='$photo' WHERE id=$id");
            $updatebook->execute();
...
<div id="opacity">
    ...
    <div class="main">
        ...
        <div>
            <a href="admin_managing_book.php"> <button class="back" ><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i>&nbsp;Back</button> </a>
        <!--     
        ...
        <?php
          ...
          <form method ="POST" action ="" enctype = "multipart/form-data" id="admin_form">
            <div class = "form-group">
                <label>Title:</label>
                <input type = "text" required = "required" name = "title" class = "form-control" value="<?php echo $s->title;  ?>" />
            </div>	
            <div class = "form-group">	
                <label>Description:&nbsp;</label>
                <input type = "text"  name = "description" required = "required" class = "form-control" value="<?php echo $s->description;  ?>" />
            </div>	
            <div class = "form-group">	
                <label>Author:</label>
                <input type = "text" name = "author" required = "required" class = "form-control" value="<?php echo $s->author;  ?>" />
            </div>	

            <div class = "form-group">	
                <label>Category:</label>
                <input type = "text" required = "required" name = "category" class = "form-control" value="<?php echo $s->category;  ?>"/>
            </div>
            <div class = "form-group">	
                <label>Date Pub:&nbsp;&nbsp;</label>
                <input type ="text" name ="datepublish" required = "required" class = "form-control" value="<?php echo $s->datepublish;  ?>"/>
            </div>
            <div class = "form-group">	
                <label>Qty:&nbsp;&nbsp;</label>
                <input type ="text" name ="qty" required = "required" class = "form-control" value="<?php echo $s->qty;  ?>"/>
            </div>
            <div class = "form-group">	
                <label>Photo:&nbsp;&nbsp;</label>
                <input type ="text" name ="photo" required = "required" class = "form-control" value="<?php echo $s->photo;  ?>"/>
            </div>
            <div class = "form-group">
                <button type="submit"  name ="edit_book"><span class = "glyphicon glyphicon-save"></span> Submit</button>
            </div>
        </form>		
